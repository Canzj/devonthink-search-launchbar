...
class DefaultConfig:
    ...
    devonthink_bundle_id = 'com.devon-technologies.think3' # Bundle ID for DEVONthink app.
...
class UserConfig(DefaultConfig):
    ...
    devonthink_bundle_id = 'com.devon-technologies.think3' # Change to 'com.devon-technologies.think' if using DEVONthink 4
